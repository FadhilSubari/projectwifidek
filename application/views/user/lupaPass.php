  ...
  <div class="row justify-content-center form-login px-5">
    <div class="col-md-5 py-5 p-4 cs-radius shadow cs-color-dsw">
      ...
      <header class="text-center">
        <h2 class="font-weight-bolder cs-color-dsw ">Lupa Password</h2>
      </header>
      <form action="<?= base_url('user/reset-password'); ?>" method="POST">
        ...
        <button type="submit" class="btn btn-bg-dsw2 text-white">Reset Password</button>
